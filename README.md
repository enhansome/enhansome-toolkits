...
* [Next.js](https://github.com/zeit/next.js) ⭐ 142,279 | 🐛 3,367 | 🌐 JavaScript | 📅 2026-09-14 - Next.js is a minimalistic framework for server-rendered React applications.
...
* [Strapi](https://github.com/strapi/strapi/) ⭐ 73,147 | 🐛 552 | 🌐 TypeScript | 📅 2026-09-14 - 🚀 Node.js Content Management Framework (headless-CMS) to build powerful API with no effort.
* [Docusaurus](https://github.com/facebook/Docusaurus) ⭐ 66,245 | 🐛 400 | 🌐 TypeScript | 📅 2026-09-14 - Easy to maintain open source documentation websites.
* [Webpack](https://github.com/webpack/webpack) ⭐ 65,949 | 🐛 124 | 🌐 JavaScript | 📅 2026-09-14 - A bundler for javascript and friends. Packs many modules into a few bundled assets. Code Splitting allows to load parts for the application on demand. Through "loaders," modules can be CommonJs, AMD, ES6 modules, CSS, Images, JSON, Coffeescript, LESS, ... and your custom stuff.
* [Nuxt.js](https://github.com/nuxt/nuxt.js) ⭐ 60,854 | 🐛 479 | 🌐 TypeScript | 📅 2026-09-14 - Versatile Vue.js Framework.
* [Gatsby](https://github.com/gatsbyjs/gatsby) ⭐ 55,938 | 🐛 449 | 🌐 JavaScript | 📅 2026-09-14 - ⚛️📄🚀 Blazing-fast static site generator for React.
...
* [Angular CLI](https://github.com/angular/angular-cli) ⭐ 27,022 | 🐛 265 | 🌐 TypeScript | 📅 2026-09-11 - CLI tool for Angular.
...
* [react-scripts](https://github.com/facebookincubator/create-react-app/tree/master/packages/react-scripts) ⭐ 103,261 | 🐛 2,411 | 🌐 JavaScript | 📅 2025-02-15 - This package includes scripts and configuration used by Create React App.
...
* [Awesome](https://github.com/sindresorhus/awesome) ⭐ 505,888 | 🐛 106 | 📅 2026-09-02 - 😎 Curated list of awesome lists.
* [Awesome Node.js](https://github.com/sindresorhus/awesome-nodejs) ⭐ 66,804 | 🐛 25 | 📅 2026-09-02 - ⚡️ Delightful Node.js packages and resources.
...
* [Popular alternatives to Create React App](https://github.com/facebookincubator/create-react-app#popular-alternatives) ⭐ 103,261 | 🐛 2,411 | 🌐 JavaScript | 📅 2025-02-15 in the official Create React App repo.
