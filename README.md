...
* [Next.js](https://github.com/zeit/next.js) ⭐ 141,769 | 🐛 4,224 | 🌐 JavaScript | 📅 2026-08-15 - Next.js is a minimalistic framework for server-rendered React applications.
...
* [Strapi](https://github.com/strapi/strapi/) ⭐ 72,910 | 🐛 540 | 🌐 TypeScript | 📅 2026-08-14 - 🚀 Node.js Content Management Framework (headless-CMS) to build powerful API with no effort.
* [Webpack](https://github.com/webpack/webpack) ⭐ 65,979 | 🐛 144 | 🌐 JavaScript | 📅 2026-08-14 - A bundler for javascript and friends. Packs many modules into a few bundled assets. Code Splitting allows to load parts for the application on demand. Through "loaders," modules can be CommonJs, AMD, ES6 modules, CSS, Images, JSON, Coffeescript, LESS, ... and your custom stuff.
* [Docusaurus](https://github.com/facebook/Docusaurus) ⭐ 65,924 | 🐛 427 | 🌐 TypeScript | 📅 2026-08-13 - Easy to maintain open source documentation websites.
...
* [Angular CLI](https://github.com/angular/angular-cli) ⭐ 27,019 | 🐛 292 | 🌐 TypeScript | 📅 2026-08-14 - CLI tool for Angular.
...
* [ember-cli](https://github.com/ember-cli/ember-cli) ⭐ 3,237 | 🐛 158 | 🌐 JavaScript | 📅 2026-08-14 - The Ember.js command line utility.
...
* [react-scripts](https://github.com/facebookincubator/create-react-app/tree/master/packages/react-scripts) ⭐ 103,312 | 🐛 2,411 | 🌐 JavaScript | 📅 2025-02-15 - This package includes scripts and configuration used by Create React App.
...
* [Awesome](https://github.com/sindresorhus/awesome) ⭐ 495,841 | 🐛 100 | 📅 2026-06-30 - 😎 Curated list of awesome lists.
* [Awesome Node.js](https://github.com/sindresorhus/awesome-nodejs) ⭐ 66,525 | 🐛 26 | 📅 2026-05-03 - ⚡️ Delightful Node.js packages and resources.
...
* [Popular alternatives to Create React App](https://github.com/facebookincubator/create-react-app#popular-alternatives) ⭐ 103,312 | 🐛 2,411 | 🌐 JavaScript | 📅 2025-02-15 in the official Create React App repo.
