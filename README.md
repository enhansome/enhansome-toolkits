...
* [Next.js](https://github.com/zeit/next.js) ⭐ 141,779 | 🐛 4,270 | 🌐 JavaScript | 📅 2026-08-14 - Next.js is a minimalistic framework for server-rendered React applications.
...
* [Strapi](https://github.com/strapi/strapi/) ⭐ 72,874 | 🐛 525 | 🌐 TypeScript | 📅 2026-08-13 - 🚀 Node.js Content Management Framework (headless-CMS) to build powerful API with no effort.
* [Webpack](https://github.com/webpack/webpack) ⭐ 65,983 | 🐛 142 | 🌐 JavaScript | 📅 2026-08-14 - A bundler for javascript and friends. Packs many modules into a few bundled assets. Code Splitting allows to load parts for the application on demand. Through "loaders," modules can be CommonJs, AMD, ES6 modules, CSS, Images, JSON, Coffeescript, LESS, ... and your custom stuff.
* [Docusaurus](https://github.com/facebook/Docusaurus) ⭐ 65,917 | 🐛 427 | 🌐 TypeScript | 📅 2026-08-13 - Easy to maintain open source documentation websites.
* [Nuxt.js](https://github.com/nuxt/nuxt.js) ⭐ 60,757 | 🐛 538 | 🌐 TypeScript | 📅 2026-08-14 - Versatile Vue.js Framework.
* [Gatsby](https://github.com/gatsbyjs/gatsby) ⭐ 55,943 | 🐛 420 | 🌐 JavaScript | 📅 2026-08-12 - ⚛️📄🚀 Blazing-fast static site generator for React.
...
* [Angular CLI](https://github.com/angular/angular-cli) ⭐ 27,019 | 🐛 293 | 🌐 TypeScript | 📅 2026-08-13 - CLI tool for Angular.
...
* [ember-cli](https://github.com/ember-cli/ember-cli) ⭐ 3,237 | 🐛 161 | 🌐 JavaScript | 📅 2026-08-13 - The Ember.js command line utility.
...
* [react-scripts](https://github.com/facebookincubator/create-react-app/tree/master/packages/react-scripts) ⭐ 103,328 | 🐛 2,411 | 🌐 JavaScript | 📅 2025-02-15 - This package includes scripts and configuration used by Create React App.
...
* [Awesome](https://github.com/sindresorhus/awesome) ⭐ 495,479 | 🐛 99 | 📅 2026-06-30 - 😎 Curated list of awesome lists.
* [Awesome Node.js](https://github.com/sindresorhus/awesome-nodejs) ⭐ 66,516 | 🐛 26 | 📅 2026-05-03 - ⚡️ Delightful Node.js packages and resources.
...
* [Popular alternatives to Create React App](https://github.com/facebookincubator/create-react-app#popular-alternatives) ⭐ 103,328 | 🐛 2,411 | 🌐 JavaScript | 📅 2025-02-15 in the official Create React App repo.
