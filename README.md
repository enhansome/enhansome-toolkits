...
* [Next.js](https://github.com/zeit/next.js) ⭐ 141,888 | 🐛 3,961 | 🌐 JavaScript | 📅 2026-08-23 - Next.js is a minimalistic framework for server-rendered React applications.
...
* [Strapi](https://github.com/strapi/strapi/) ⭐ 73,002 | 🐛 538 | 🌐 TypeScript | 📅 2026-08-21 - 🚀 Node.js Content Management Framework (headless-CMS) to build powerful API with no effort.
* [Docusaurus](https://github.com/facebook/Docusaurus) ⭐ 66,047 | 🐛 401 | 🌐 TypeScript | 📅 2026-08-22 - Easy to maintain open source documentation websites.
* [Webpack](https://github.com/webpack/webpack) ⭐ 65,975 | 🐛 141 | 🌐 JavaScript | 📅 2026-08-23 - A bundler for javascript and friends. Packs many modules into a few bundled assets. Code Splitting allows to load parts for the application on demand. Through "loaders," modules can be CommonJs, AMD, ES6 modules, CSS, Images, JSON, Coffeescript, LESS, ... and your custom stuff.
...
* [Angular CLI](https://github.com/angular/angular-cli) ⭐ 27,015 | 🐛 278 | 🌐 TypeScript | 📅 2026-08-21 - CLI tool for Angular.
* [Razzle](https://github.com/jaredpalmer/razzle) ⭐ 11,026 | 🐛 135 | 🌐 JavaScript | 📅 2024-03-11 - ✨ Create server-rendered universal JavaScript applications with no configuration.
...
* [react-scripts](https://github.com/facebookincubator/create-react-app/tree/master/packages/react-scripts) ⭐ 103,291 | 🐛 2,408 | 🌐 JavaScript | 📅 2025-02-15 - This package includes scripts and configuration used by Create React App.
...
* [Awesome](https://github.com/sindresorhus/awesome) ⭐ 499,027 | 🐛 106 | 📅 2026-08-21 - 😎 Curated list of awesome lists.
* [Awesome Node.js](https://github.com/sindresorhus/awesome-nodejs) ⭐ 66,594 | 🐛 26 | 📅 2026-05-03 - ⚡️ Delightful Node.js packages and resources.
...
* [Popular alternatives to Create React App](https://github.com/facebookincubator/create-react-app#popular-alternatives) ⭐ 103,291 | 🐛 2,408 | 🌐 JavaScript | 📅 2025-02-15 in the official Create React App repo.
